...
public class ItemGenerator {
    ...
    private final String WEAPONS_FILE = "src/main/resources/data/enemies.json";
    private final String FOOD_FILE = "src/main/resources/data/food.json";


    public ItemGenerator() throws FileNotFoundException {
        Gson gson = new Gson();
        this.weapons = gson.fromJson(new FileReader(WEAPONS_FILE), new TypeToken<List<WeaponItem>>(){}.getType());
        this.foods = gson.fromJson(new FileReader(FOOD_FILE), new TypeToken<List<HealingItem>>(){}.getType());
        random = new Random();
    }
