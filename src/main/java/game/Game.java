...
public class Game {
    ...
    public void startGame() {
        ...
        woodland = new Location("Woodland", "\uD83C\uDF33", "A dense forest filled with dangerous enemies and valuable treasures. game.Location of the master sword.", "woodland", iron_sword);
